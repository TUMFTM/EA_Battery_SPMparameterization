...
function [t_sim, U_sim] = spmet_fnc(t, I, T, CA, Nr, Nxn, Nxs, Nxp)
% t = Time vector in h
...
% Integrate
[t_sim,x] = ode23s(@(t,x) ode_spmet(t,x,data,p),t_sim,x0,options); % Solve SPMeT
